    ...
    public class PasswordsController : Controller
    {
        ...
        public IQueryable<Password> GetPasswords()
        {
            ...
            var audit = new Audit {
                ...
                Notes = this.Request.Headers["User-Agent"].ToString()
            };
        ...
        [HttpGet("{id}")]
        public async Task<IActionResult> GetPassword(long id)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> PostPassword(Password password)
        {
            if (!ModelState.IsValid) {
                return BadRequest(ModelState);
            }
